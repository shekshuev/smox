...
Revision ID: 37f8e87252bd
Revises: 
Create Date: 2020-11-18 23:27:13.341119
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['access_profile_id'], ['access_profiles.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('downloaded_date', sa.DateTime(), nullable=False),
