    ...
    <v-container>        
        <v-dialog v-model="dialog" persistent max-width="600px">
            <template v-slot:activator="{ on, attrs }">
                <v-btn v-on="on" v-bind="attrs" color="primary" fab absolute bottom right class="add-btn">
                ...
                <v-card-text>
                    <v-container>
                        <v-row>
                            <v-col cols="12" sm="12">
                                <v-toolbar flat>
                                    <v-text-field v-model="keyword" hide-details label="Ключевые слова" single-line></v-text-field>
